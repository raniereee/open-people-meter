...
class Dejavu(object):
	...
	print "PATH: %s   extensions: %s" %(path, extensions)
	...
	print "File names to FP: ", filenames_to_fingerprint
		...
		print "Song name: %s  LenHashes: %d" % (song_name, len(hashes))
		...
		print "Vai inserir o audio: %s" % song_name
        ...
        pool.close()
        pool.join()
	print "Terminou de inserir os dados no banco"
